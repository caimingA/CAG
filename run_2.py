...
def run(name, DAG_list, data_list, B_list, alpha_l_list, alpha_i_list, alpha_p = [1]):
    ...
    # recorder.write_excel(res_list_1, res_L, res_K[0], res_RCD_list, name + "_Wald_F")
    # recorder.write_excel(res_list_2, res_L, res_K[1], res_RCD_list, name + "_Ance_F")
    # recorder.write_excel(res_list_3, res_L, res_K[2], res_RCD_list, name + "_Valu_F")
