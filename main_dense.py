...
if __name__ == '__main__':
    ...
    # experiment_set = [(10, 20, 2), (10, 9, 1)]
    # experiment_set = [(10, 17, 2), (10, 24, 3), (20, 38, 2), (20, 54, 3)]
    # experiment_set = [(20, 37, 2), (20, 54, 3)]
    experiment_set = [(10, 10, 2), (10, 12, 2), (10, 14, 2), (10, 16, 2)]
    # experiment_set = [(20, 19, 1)]
    # experiment_set = [(30, 29, 1)]
    # experiment_set = [(40, 39, 1)]
    ...
    for dir_path in dir_list:
        ...
        for s in range(2, len(res_list[0])):
            if len(res_list[0][s]) <= 500:
                ...
                run_dense.run(name, DAG_list, x_list, B_list, alpha_l_list, alpha_i_list, alpha_p)
        count += 1
